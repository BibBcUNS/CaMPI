...
?>
		...
		<script type="text/javascript">
			...
			function validForm(passForm) {		
				...
				// Controlamos que el campo MFN DESTINO no seteó vacio
...
<body>
	...
	<form onsubmit="return validForm(this)" action="ucod_2_marc_do.php" method="post"
	...
	">
		...
		<table border="0" cellspacing="10" align="center">
			<tr>
				<td colspan="2"><H3>Mover Registro de UCOD-MARC a EUNM</H3></td>
			</tr>
			<tr>
				<td align="right">Número de registro</td>
				<td align="left"> <input type="text" name="nc_ucod" size="6"></input></td>
			</tr>
			<tr align="center">
				<td colspan="2"> <br> <input type="submit" value="Mover de UCOD-MARC a EUNM"> </td>
			</tr>
	</form>		
	</table>
