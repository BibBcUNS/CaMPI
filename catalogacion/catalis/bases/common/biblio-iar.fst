...
0000 0 /*                                                    */
0000 0 /* (c) 2003-2005 Fernando J. Gomez - CONICET - INMABB */
0000 0 /* ================================================== */
...
0000 0 /* --- Campo 653 completo para Boeris only. 28/03/2006 --- */
9653 0 (replace(v653^a,' ','_')/)  /* requiere usar "_" al hacer una búsqueda  */
...
9859 0 if p(v859) then ( '-ST=', if v859^k<>'' then v859^k,x1, fi, v859^h, if v859^i<>'' then x1,v859^i, fi, if s(v859^k,v859^h,v859^i) = '' then '---' fi / ) fi
9859 0 if nocc(v859) > 1 then '-MULTIEJEMPLAR' fi
9920 0 if p(v920) then ('-TIPO-DOC=',v920^a/) fi
