...
// -----------------------------------------------------------------------------
{
	...
	if ( "a" != leader_18 ) {
		...
		var message = "";
		message += "Atención: este registro parece no haber sido creado usando AACR2:";
...
// -----------------------------------------------------------------------------
{
	switch (tag) {
		...
		case "504" :
			...
			sf = sf.replace(/\^aIncludes bibliographies\.|\^aIncludes bibliographical references\./,"^aIncluye referencias bibliográficas.");
			break;
