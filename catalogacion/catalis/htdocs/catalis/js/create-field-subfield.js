...
// -----------------------------------------------------------------------------
{
  ...
  else if ( "5" == code ) {   // Acá se pueden cargar los codigos de Institution code (mismo que institucion en existencias)
    newSubfieldBox.value = "";
    newSubfieldBox.readOnly = false;
  }
