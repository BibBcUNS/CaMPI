...
*/
        // Validate Input
        $patron = [
            'cat_username'=>$request->getPost()->get('username'),
            'id'=>$request->getPost()->get('username'),
...
//        $user->saveCredentials($patron['cat_username'], $params['password']);
        $user->saveCredentials($username, $params['password']);
        return $user;
    }
     ...
     */
     ...
     // protected -> private: modificado por jeronimo
    public function processILSUser($info)
    {
